...
IGuiPage
{
	...
	IGuiSliderSwitchHorizontal
	{
		...
		qm_BorderWidth: 2
		qm_ImageSource: "image://QSmartImageProvider/56#2#4#128#0#0"
		qm_Border.top: 5
		qm_Border.bottom: 5
		qm_Border.right: 5
		qm_Border.left: 5
		...
		qm_SliderGripImageID: 57
		qm_SliderGripTileWidth: 8
		qm_SliderGripTileHeight: 56
		qm_SliderGripTileTop: 22
		qm_SliderGripTileBottom: 22
